...
//   cx.beginPath();
 ...
 centerY = 0;
  ...
  if (len > 2) {
    ...
    ctx.fillStyle = "rgba(46, 246, 120, 0.3)";
    ctx.fill();
            ...
            function draw_measure(evt) {
                ...
                if (moveTimer == null) {
                  ...
                  // alert('a:'+JSON.stringify(previous_touches))
                    ...
                    isDetecting = false;
                    drawScreen()
                    var i1_introduction = document.getElementById('i1_introduction');
                    i1_introduction.style.display = 'none';
                    var i2_up_down = document.getElementById('i2_up_down');
                    i2_up_down.style.display = 'block';
